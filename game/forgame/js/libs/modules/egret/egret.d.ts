...
declare namespace egret {
    ...
    class DisplayObject extends EventDispatcher {
        ...
        /**
         * Indicates the width of the display object, in pixels. The width is calculated based on the bounds of the contents
         ...
         * contents of the display object.
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
         */
         ...
         * increase performance for display objects that contain complex vector contents. After you set the cacheAsBitmap
         * property to true, the rendering does not change, however the display object performs pixel snapping automatically.
         * The execution speed can be significantly faster depending on the complexity of the contents.The cacheAsBitmap
         * property is best used with display objects that have mostly static contents and that do not scale and rotate frequently.<br/>
...
declare namespace egret {
    ...
    class StageScaleMode {
        /**
         * Do not scale application contents. Even when you change the player viewport size, it remains unchanged. If the player is smaller than the viewport contents, possibly with some cropping.<br/>
        ...
        /**
         * Keep the original aspect ratio scaling application contents, after scaling a wide directions application contents to fill the viewport players on both sides in the other direction may not be wide enough and left black bars.<br/>
         * In this mode, the stage size (Stage.stageWidth, Stage.stageHeight) is always equal to the initialization incoming external application contents size.
         * @language en_US
         */
        /**
        ...
        /**
         * Keep the original aspect ratio scaling application contents, after scaling a narrow direction of application contents to fill the viewport players on both sides in the other direction may exceed the viewport and the player is cut.<br/>
         * In this mode, the stage size (Stage.stageWidth, Stage.stageHeight) is always equal to the initialization incoming external application contents size.
         * @language en_US
         */
        /**
        ...
        /**
         * Do not keep the original aspect ratio scaling application contents, after scaling application contents just fill the player viewport.<br/>
         * In this mode, the stage size (Stage.stageWidth, Stage.stageHeight) is always equal to the initialization incoming external application contents size.
         * @language en_US
         */
        /**
        ...
        /**
         * Keep the original aspect ratio scaling application contents, after scaling application contents in the horizontal and vertical directions to fill the viewport player, but only to keep the contents of the original application constant width, height may change.<br/>
         * In this mode, the stage width (Stage.stageWidth) is always equal to initialize external incoming application contents width. Stage height (Stage.stageHeight) by the current scale with the player viewport height decision.
         * @language en_US
         */
        /**
        ...
        /**
         * Keep the original aspect ratio scaling application contents, after scaling application contents in the horizontal and vertical directions to fill the viewport player, but only to keep the contents of the original application constant height, width may change.<br/>
         * In this mode, the stage height (Stage.stageHeight) is always equal to initialize external incoming application contents height. Stage width (Stage.stageWidth) by the current scale with the player viewport width decision.
         * @language en_US
         */
        /**
        ...
        /**
         * Keep the original aspect ratio scaling application contents, after scaling application contents in the horizontal and vertical directions to fill the viewport player,a narrow direction may not be wide enough and fill.<br/>
        ...
        /**
         * Keep the original aspect ratio scaling application contents, after scaling application contents in the horizontal and vertical directions to fill the viewport player, a wide direction may exceed the viewport and the player is cut.<br/>
         * In this mode, the stage height (Stage.stageHeight) and the stage width (Stage.stageWidth) by the current scale with the player viewport size.
         * @language en_US
         */
        /**
...
declare namespace egret {
    ...
    class Capabilities {
        /**
         * Specifies the language code of the system on which the contents is running. The language is specified as a lowercase
...
declare namespace egret {
    ...
    class HorizontalAlign {
        /**
         * Horizontally align contents to the left of the container.
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
         */
        ...
        static LEFT: string;
        /**
         * Horizontally align contents to the right of the container.
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
         */
        ...
        static RIGHT: string;
        /**
         * Horizontally align contents in the center of the container.
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
         */
        ...
        /**
         * Align the contents of the child items, relative to the container. This operation will adjust uniformly the size of all the child items to be the Content Width \" of the container \".
...
declare namespace egret {
    ...
    class VerticalAlign {
        /**
         * Vertically align contents to the top of the container.
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
         */
        ...
        static TOP: string;
        /**
         * Vertically align contents to the bottom of the container.
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
         */
        ...
        /**
         * Vertically align contents in the middle of the container.
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
         */
        ...
        static JUSTIFY: string;
        /**
         * Align the contents of the child items, relative to the container. This operation will adjust uniformly the size of all the child items to be the Content Height \" of the container \".
...
declare namespace egret {
    ...
    class Stage extends DisplayObjectContainer {
         ...
         * <li>StageScaleMode.NO_SCALE -- The size of the entire application is fixed, so that even if the size of the player window changes, it remains unchanged. If the player window is smaller than the contents, it may do some trimming.</li>
         * <li>StageScaleMode.NO_BORDER -- Keep the original aspect ratio scaling application contents, after scaling a narrow direction of application contents to fill the viewport players on both sides in the other direction may exceed the viewport and the player is cut.</li>
         * <li>StageScaleMode.FIXED_WIDTH -- Keep the original aspect ratio scaling application contents, after scaling application contents in the horizontal and vertical directions to fill the viewport player, but only to keep the contents of the original application constant width, height may change.</li>
         * <li>StageScaleMode.FIXED_HEIGHT -- Keep the original aspect ratio scaling application contents, after scaling application contents in the horizontal and vertical directions to fill the viewport player, but only to keep the contents of the original application constant height, width may change.</li>
         * </ul>
