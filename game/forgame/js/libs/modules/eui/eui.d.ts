...
declare namespace eui {
    ...
    interface UIComponent extends egret.DisplayObject {
         ...
         * center of the anchor target's contents area.
         *
         * @default NaN
         *
         * @version Egret 2.4
...
declare namespace eui {
    ...
    class LayoutBase extends egret.EventDispatcher {
        ...
        /**
         * Measures the target's default size based on its contents.
         *
         * @version Egret 2.4
         * @version eui 1.0
         * @platform Web,Native
...
declare namespace eui {
    ...
    class ScrollBarBase extends Component {
         ...
         *
         * If a viewport is specified, then changes to its actual size, contents
...
declare namespace eui {
    ...
    class DefaultAssetAdapter implements IAssetAdapter {
         ...
         * example：callBack(contents:any,source:string):void;
         ...
         * @param callBack 解析完成回调函数，示例：callBack(contents:any,source:string):void;
...
declare namespace eui {
     ...
     * a closeButton, a moveArea, and a contents area for its children.
     *
...
declare namespace eui {
    ...
    interface IViewport extends UIComponent {
         ...
         * and the viewport's actual width defines how much of the contents is visible.
         *
         * To scroll through the contents horizontally, vary the
        ...
        contentWidth: number;
        /**
         * The height of the viewport's contents.
         *
         * If <code>scrollEnabled</code> is true, the viewport's
         * <code>contentHeight</code> defines the limit for vertical scrolling
         * and the viewport's actual height defines how much of the contents is visible.
         *
         * To scroll through the contents vertically, vary the
...
declare namespace eui {
    ...
    class JustifyAlign {
         ...
         * This uniformly sizes all children to be the contents width/height of the container.
         * The contents width/height of the container is the size of the largest child.
